...
Prep documents must read like they were written by a person, not generated by a tool. The target register is professional and conversational: direct, grounded, and confident without being stiff or performative. A candidate reading their prep document should feel like a peer prepared it for them, not like they are reading a template.

Specific rules that apply to every document without exception:

No em dashes (U+2014) or en dashes (U+2013) anywhere in the document. Use a comma, a colon, or restructure the sentence. This is a hard rule with no exceptions.

No AI quips or rhetorical flourishes. Phrases like "that is a hard job," "that is the professional opportunity that is genuinely hard to replicate anywhere else right now," "that is where you operate," or "the technology being good is table stakes" are the signature of AI-generated prose. Remove them. Say the thing plainly.

No stacked short declarative sentences used for dramatic effect. "These are not proofs of concept. They are in production." "The technology was the easy part." Writing that fragments sentences to create rhythm reads as artificial and undermines credibility.

No meta-commentary in answer blocks. Phrases like "that distinction is something I bring into every AI initiative now" or "that is the part I now treat as the first job" are editorializing about the answer inside the answer. Cut them.

No filler transitions. "From there," "what actually drives," "what I have found," used repeatedly as paragraph openers, are padding. Vary sentence structure and lead with substance.

No unsolicited affirmations. The prep document does not comment on how strong the candidate's experience is or how well it maps. It presents the information. The candidate decides how to use it.

**Anchor answers**

Anchor answers are the talking points a candidate builds from, not word-for-word scripts. Write them in first person, present tense, at a natural speaking register. They should sound like something a person would actually say in a conversation, not like a polished written response.

Each paragraph in an anchor answer should carry a distinct point. Do not repeat the same idea in different words. Do not over-explain. Trust the candidate to fill in context from their own experience.

If a question has a natural three-part structure (context, what I did, what changed), use that structure. Do not force three parts onto every question.

**Structure**
- Prep documents are written to the candidate, not about them. Use "you" and "your" in guidance sections.
- Anchor answer blocks are written in the candidate's voice: first person.
- Callout boxes for key statements such as the core narrative, the opening position, and things to avoid.
...
- One blank line between paragraphs in anchor answer blocks. Do not run paragraphs together.
